<?php
// INICIAR SESSIÓN DE VARIABLES
session_start();
 

// VERIFICAR SI HAT CAMBIOS DE LENGUAJE MEDIANTE POST
if(isset($_POST["lang"])){
  $lang = $_POST["lang"];
  if(!empty($lang)){
    $_SESSION["lang"] = $lang;
...
if(isset($_SESSION['lang'])){
  // SI LA CONDICIÓN SE CUMPLE ES MOSTRADO LA VARIABLE DE ARRAY LANGUAGE
  $lang = $_SESSION["lang"];
  // echo "<script> alert('VARIABLE SESSION: $lang'); </script>";
  require "lang/".$lang.".php";
  
  //SI LA SESIÓN AÚN NO HA SIDO CARGADA CARGARA LA VERSIÓN POR DEFAULT EN ESPAÑOL
}else{
  require "lang/es.php";
}
?>
